...
const T: Record<AdminLang, Record<string, string>> = {
  en: {
    ...
    'menu.searchItems': 'Search items…', 'menu.searchToppings': 'Search toppings…',
    ...
    'customers.loyaltyBalance': 'Bonus Balance', 'customers.loyaltyNotLinked': 'No bonus account',
    'customers.loyaltyUnavailable': 'Bonuses unavailable', 'customers.bonuses': 'Bonuses',
    'customers.loyaltyRefresh': 'Refresh',
  ...
  ru: {
    ...
    'menu.searchItems': 'Поиск блюд…', 'menu.searchToppings': 'Поиск топпингов…',
    ...
    'customers.loyaltyBalance': 'Бонусный баланс', 'customers.loyaltyNotLinked': 'Нет бонусного счёта',
    'customers.loyaltyUnavailable': 'Бонусы недоступны', 'customers.bonuses': 'Бонусы',
    'customers.loyaltyRefresh': 'Обновить',
  ...
  kk: {
    ...
    'menu.searchItems': 'Тауар іздеу…', 'menu.searchToppings': 'Топпинг іздеу…',
    ...
    'customers.loyaltyBalance': 'Бонус балансы', 'customers.loyaltyNotLinked': 'Бонус шоты жоқ',
    'customers.loyaltyUnavailable': 'Бонустар қолжетімсіз', 'customers.bonuses': 'Бонустар',
    'customers.loyaltyRefresh': 'Жаңарту',
